...
class AccountMove(models.Model):
    ...
    def do_pyafipws_request_cae(self):
        ...
        for inv in self:
            ...
            # harcodeo la numeracion de la secuencia de la factura, esto es para evitar que
            # por algun motivo pierda el sincronismo con Afip.
            #FA-B 00020-00000001
            numero_ws = '{:>05s}-{:>08s}'.format(str(ws.PuntoVenta), str(ws.CbteNro))
            ...
            inv.write({
                ...
                'name': numero_ws,
                'invoice_payment_ref': numero_ws,
                'l10n_latam_document_number': numero_ws
            })
